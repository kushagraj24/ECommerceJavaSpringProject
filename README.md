...
3. Make sure you are in the `ECommerceJavaProject` directory
...
5. Run the project (by running the `main` method in `ECommerceJavaProjectApplication.java`)
6. Open http://localhost:8080/ in your browser!
   * If you ran the [`basedata.sql`](https://github.com/kushagraj24/ECommerceJavaSpringProject/blob/main/ECommerceJavaProject/ECommerceJavaProject/basedata.sql)script on the database, you can log in with the following credentials as admin; otherwise you'll have to manually create an admin user in the database:
     * Username: `admin`
     * Password: `123`
...
2. Click on the `ECommerceJavaProjectApplication` configuration
